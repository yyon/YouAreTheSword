...
function dialog:initialize(game)
  ...
  self.buttons.sound_up_button = menubutton(self, center_x, y, 600, 60, "Sound Volume +", function() self:sound_up() end)
  y = y + 70
  self.buttons.sound_down_button = menubutton(self, center_x, y, 600, 60, "Sound Volume -", function() self:sound_down() end)
  y = y + 70
  self.buttons.music_up_button = menubutton(self, center_x, y, 600, 60, "Music Volume +", function() self:music_up() end)
  y = y + 70
  self.buttons.music_down_button = menubutton(self, center_x, y, 600, 60, "Music Volume -", function() self:music_down() end)
  y = y + 70
